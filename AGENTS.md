...
The dev servers can be run in a tmux session so Codex can read logs:
...
This allows Codex to monitor server output, debug issues, and verify changes in real-time.
